...
Last updated: 2026-09-10 (MR terminology in all labels; Accounts step of PO approval now opt-in via Settings > Purchase approval process (po_accounts_process, default OFF) - a signed slip is complete; emails kept for received-to-sign and signed-back).
