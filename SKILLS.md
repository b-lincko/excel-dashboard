...
Last updated: 2026-09-10 (approvals desk rebuilt per user feedback: personal tabs To sign / Sent to sign / Received signed, Remind-with-message, route endpoint 405 fixed, decide honours return_to, sign window auto-closes with stamp, semantic button colors btn-go/btn-warn).
