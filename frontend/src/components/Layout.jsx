...
const NAV = [
  ...
  { to: "/approvals", label: "Purchase Approval", icon: PenLine, group: "Daily", page: "po_approvals" },
  ...
  const sidebar = (
    <>
      <div className="px-5 py-5 flex items-center gap-3">
        <BrandLogo className="h-9 w-auto max-w-[148px] object-contain" />
