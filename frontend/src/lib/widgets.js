...
export const KPI_METRICS = [
  ...
  { id: "blockades", label: "Blockades", accent: "rose", source: "kpis", click: { flag: "blockade" } },
...
export const DATASETS = [
  ...
  { id: "blockades", label: "Blockades", kind: "dist", dataKey: "blockades", filterKey: "status", extra: { flag: "blockade" } },
